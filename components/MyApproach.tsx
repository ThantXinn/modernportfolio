  ...
  return (
    <section className='w-full py-20'>
      <h1 className='heading'>
        My <span className='text-purple'>Apporach</span>
      </h1>
      <div className='py-20 flex flex-col lg:flex-row items-center justify-center w-full gap-6 mx-auto'>
        <Card
          title='Crafting the Future'
          icon={<AceternityIcon title='Phase 1' />}
          desc='Transforming ideas into impactful, future-proof web solutions that resonate with users.'>
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          desc='Balancing creativity and technical precision to deliver high-performance, responsive websites.'>
          <CanvasRevealEffect
            animationSpeed={3}
